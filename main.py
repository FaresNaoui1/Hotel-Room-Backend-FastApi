...
from Controller.Hotel_Controller import router as Hotel_Controller  # Import the router
...
app = FastAPI()
app.include_router(Hotel_Controller, prefix="/hotels")
# Create datab=
...
# Get user details
@app.get("/users/{user_id}", response_model=UserBase, status_code=200)
